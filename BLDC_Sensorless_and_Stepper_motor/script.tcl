...
download_core -vlnv {Microsemi:SolutionCore:BLDC_ESTIMATOR:4.2.0} -location {www.microchip-ip.com/repositories/DirectCore}
...
download_core -vlnv {Microsemi:SolutionCore:SEQ_CONTROLLER:4.1.1} -location {www.microchip-ip.com/repositories/DirectCore}
download_core -vlnv {Microsemi:SolutionCore:SPEED_ID_IQ_PI:4.1.0} -location {www.microchip-ip.com/repositories/DirectCore}
download_core -vlnv {Microsemi:SolutionCore:STEPPER_THETA:4.1.0} -location {www.microchip-ip.com/repositories/DirectCore}
...
file delete -force SK2ABLSL_2024_log.txt

save_log -file SK2ABLSL_2024_log.txt
