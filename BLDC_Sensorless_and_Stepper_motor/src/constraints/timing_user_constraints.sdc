...
#create_generated_clock  -name { MC_System_0/MC_System_sb_0/CCC_0/GL2 } \
    #-divide_by 8  -multiply_by 4  \
    #-source {MC_System_0/MC_System_sb_0/FABOSC_0/I_RCOSC_25_50MHZ  }  \
    #{ MC_System_0/MC_System_sb_0/CCC_0/GL2 } 
...
#set_input_delay -max 3.000 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL2 } { TD  } 
#set_input_delay -min 1.300 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL2 } { TD  } 

#set_input_delay -max 3.000 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL2 } { PPS  } 
#set_input_delay -min 1.300 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL2 } { PPS  } 

set_output_delay -max 0.300 -clock {MC_System_0/MC_System_sb_0/CCC_0/GL0} { GPIO_41  } 
set_output_delay -min 0.300 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL0} { GPIO_41  } 

#set_output_delay -max 0.300 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL2 } { GPIO_43  } 
#set_output_delay -min 0.300 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL2 } { GPIO_43  } 
