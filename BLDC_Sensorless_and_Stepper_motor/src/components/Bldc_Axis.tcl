...
sd_create_bif_port -sd_name ${sd_name} -port_name {BLDC_AXIS_IF} -port_bif_vlnv {AMBA:AMBA2:APB:r0p0} -port_bif_role {slave} -port_bif_mapping {\
"PADDR:paddr_i" \
"PSELx:psel_i" \
"PENABLE:penable_i" \
"PWRITE:pwrite_i" \
...
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:adc_control_reg_val_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:adc_channel_ch0_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:adc_channel_ch1_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:adc_channel_ch2_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:adc_channel_ch3_o}



# Add BLDC_ESTIMATOR_0 instance
sd_instantiate_core -sd_name ${sd_name} -core_vlnv Microsemi:SolutionCore:BLDC_ESTIMATOR:$BLDC_ESTIMATORver -instance_name {BLDC_ESTIMATOR_0}
# Exporting Parameters of instance BLDC_ESTIMATOR_0
sd_configure_core_instance -sd_name ${sd_name} -instance_name {BLDC_ESTIMATOR_0} -params {\
"FAMILY:19" \
"g_NO_MCYCLE_PATH:2" \
"HDL_License:O" \
"testbench:User" }\
-validate_rules 0
sd_save_core_instance_config -sd_name ${sd_name} -instance_name {BLDC_ESTIMATOR_0}
sd_invert_pins -sd_name ${sd_name} -pin_names {BLDC_ESTIMATOR_0:angle_pi_en_i}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {BLDC_ESTIMATOR_0:done_o}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:reset_i" "BLDC_ESTIMATOR_0:reset_i" "FOC_TRANSFORMS_0:reset_i" "OLMNG_0:reset_i" "PWM3PH_0:reset_i" "PWM_SCALING_0:reset_i" "RATE_LIMITER_0:reset_i" "SEQ_CONTROLLER_0:reset_i" "SPEED_ID_IQ_PI_0:reset_i" "SVM_0:reset_i" "adc_interface_795x_0:reset_i" "apb3_if_0:preset_i" "reset_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:sys_clk_i" "BLDC_ESTIMATOR_0:sys_clk_i" "FOC_TRANSFORMS_0:sys_clk_i" "OLMNG_0:sys_clk_i" "PWM3PH_0:sys_clk_i" "PWM_SCALING_0:sys_clk_i" "RATE_LIMITER_0:sys_clk_i" "SEQ_CONTROLLER_0:sys_clk_i" "SPEED_ID_IQ_PI_0:sys_clk_i" "SVM_0:sys_clk_i" "adc_interface_795x_0:sys_clk_i" "apb3_if_0:pclk_i" "sys_clk_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:angle_pi_en_i" "RATE_LIMITER_0:reset_rl_i" "SEQ_CONTROLLER_0:reset_rl_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:clear_buffer_i" "OLMNG_0:clear_buffer_i" "SEQ_CONTROLLER_0:motor_stopped_o" "SPEED_ID_IQ_PI_0:clear_buffer_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:start_i" "FOC_TRANSFORMS_0:ipark_done_o" "FOC_TRANSFORMS_0:start_iclarke_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:Ls_by_Ts_pu_i" "apb3_if_0:Ls_by_Ts_pu_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:Rs_pu_i" "apb3_if_0:Rs_pu_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:angle_pi_ki_i" "apb3_if_0:angle_ki_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:angle_pi_kp_i" "apb3_if_0:angle_kp_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:ealpha_filter_factor_i" "BLDC_ESTIMATOR_0:ebeta_filter_factor_i" "apb3_if_0:filter_factor_bemf_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:ealpha_filtered_o" "apb3_if_0:ealpha_filter_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:ealpha_o" "apb3_if_0:ealpha_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:ebeta_filtered_o" "apb3_if_0:ebeta_filter_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:ebeta_o" "apb3_if_0:ebeta_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:i_alpha_i" "FOC_TRANSFORMS_0:ialpha_i" "FOC_TRANSFORMS_0:ialpha_o" "apb3_if_0:ialpha_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:i_beta_i" "FOC_TRANSFORMS_0:ibeta_i" "FOC_TRANSFORMS_0:ibeta_o" "apb3_if_0:ibeta_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:omega_filter_factor_i" "apb3_if_0:filter_factor_omega_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:pll_pi_out_o" "apb3_if_0:omega_pi_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:pll_theta_factor_i" "OLMNG_0:theta_factor_i" "apb3_if_0:olmng_theta_factor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:speed_filtered_o" "SPEED_ID_IQ_PI_0:speed_pi_act_input_i" "apb3_if_0:omega_filter_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:theta_o" "OLMNG_0:theta_cl_i" "apb3_if_0:pll_theta_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:v_alpha_i" "FOC_TRANSFORMS_0:valpha_i" "FOC_TRANSFORMS_0:valpha_o" "apb3_if_0:valpha_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_ESTIMATOR_0:v_beta_i" "FOC_TRANSFORMS_0:vbeta_i" "FOC_TRANSFORMS_0:vbeta_o" "apb3_if_0:vbeta_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_AXIS_IF" "apb3_if_0:BLDC_AXIS_IF" }
