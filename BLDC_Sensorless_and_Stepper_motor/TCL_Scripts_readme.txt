BLDC_Sensorless_and_Stepper_motor Directory Structure

The BLDC_Sensorless_and_Stepper_motor directory is organized as shown below:

 BLDC_Sensorless_and_Stepper_motor 
     |
     |----BLDC_Sensorless_and_Stepper_motor_Job_File
     |----src
     |     |---cfg
     |     |---components
     |     |---constraints
...
BLDC_Sensorless_and_Stepper_motor Folders

BLDC_Sensorless_and_Stepper_motor_df\softconsole2021p1 folder Contains the softconsole Project to run the Design

**** Note :- Remove the .hex file from the design when you want to run the softconsole in Debug Mode

BLDC_Sensorless_and_Stepper_motor_Job_File folder contains Job File for the corresponding deisgn 
 
BLDC_Sensorless_and_Stepper_motor\src folder contains the following folders:
...
* cxf: contains MSS subsystem Files ,SNVM and spiflash configuration files.
* softconsole: contains the hex file for the paricular application.
 
TCL Files

BLDC_Sensorless_and_Stepper_motor\src includes the following TCL files:
...
The TCL scripts are validated for Libero v2024.2 and IP versions as specified in the common.tcl. To run the TCL, follow:
