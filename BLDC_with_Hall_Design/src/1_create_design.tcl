...
import_files -hdl_source {./src/hdl/apb3_hall_if.vhd}

# Import source files
build_design_hierarchy 
source ./src/components/adc_interface_795x.tcl
source ./src/components/apb3_hall_if.tcl 

build_design_hierarchy 

# Create, configure and generate core components
source ./src/components/HALL_INTERFACE_C0.tcl
source ./src/components/BLDC_HALL_Axis.tcl 
