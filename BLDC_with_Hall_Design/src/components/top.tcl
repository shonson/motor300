...
# Add BLDC_HALL_Axis_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {BLDC_HALL_Axis} -instance_name {BLDC_HALL_Axis_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"A0_ADC_CS_O" "BLDC_HALL_Axis_0:adc_cs_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"A0_ADC_SCK_O" "BLDC_HALL_Axis_0:adc_sck_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"A0_ADC_SDI_I" "BLDC_HALL_Axis_0:adc_sdi_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"A0_ADC_SDO_O" "BLDC_HALL_Axis_0:adc_sdo_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"A0_PWM_UH_O" "BLDC_HALL_Axis_0:pwm_uh" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"A0_PWM_UL_O" "BLDC_HALL_Axis_0:pwm_ul" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"A0_PWM_VH_O" "BLDC_HALL_Axis_0:pwm_vh" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"A0_PWM_VL_O" "A0_RUNNING_LED" "BLDC_HALL_Axis_0:pwm_vl" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"A0_PWM_WH_O" "BLDC_HALL_Axis_0:pwm_wh" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"A0_PWM_WL_O" "BLDC_HALL_Axis_0:pwm_wl" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_HALL_Axis_0:HA_i" "HA_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_HALL_Axis_0:HB_i" "HB_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_HALL_Axis_0:HC_i" "HC_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_HALL_Axis_0:reset_i" "MC_System_0:FIC_0_LOCK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_HALL_Axis_0:sys_clk_i" "MC_System_0:FIC_0_CLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_HALL_Axis_0:BLDC_APB_IF" "MC_System_0:AMBA_SLAVE_0" }
