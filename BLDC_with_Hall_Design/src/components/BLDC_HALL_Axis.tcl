# Creating SmartDesign "BLDC_HALL_Axis"
set sd_name {BLDC_HALL_Axis}
...
sd_create_scalar_port -sd_name ${sd_name} -port_name {HA_i} -port_direction {IN}
sd_create_scalar_port -sd_name ${sd_name} -port_name {HB_i} -port_direction {IN}
sd_create_scalar_port -sd_name ${sd_name} -port_name {HC_i} -port_direction {IN}
...
# Add apb3_hall_if_0 instance
sd_instantiate_hdl_core -sd_name ${sd_name} -hdl_core_name {apb3_hall_if} -instance_name {apb3_hall_if_0}
# Exporting Parameters of instance apb3_hall_if_0
sd_configure_core_instance -sd_name ${sd_name} -instance_name {apb3_hall_if_0} -params {\
...
"g_STD_IO_WIDTH:18" }\
-validate_rules 0
sd_save_core_instance_config -sd_name ${sd_name} -instance_name {apb3_hall_if_0}
sd_update_instance -sd_name ${sd_name} -instance_name {apb3_hall_if_0}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_hall_if_0:adc_control_reg_val_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_hall_if_0:adc_channel_ch0_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_hall_if_0:adc_channel_ch1_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_hall_if_0:adc_channel_ch2_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_hall_if_0:adc_channel_ch3_o}
...
# Add HALL_INTERFACE_C0_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {HALL_INTERFACE_C0} -instance_name {HALL_INTERFACE_C0_0}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {HALL_INTERFACE_C0_0:omega_done_o}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:reset_i" "FOC_TRANSFORMS_0:reset_i" "HALL_INTERFACE_C0_0:reset_i" "OLMNG_0:reset_i" "PWM3PH_0:reset_i" "PWM_SCALING_0:reset_i" "RATE_LIMITER_0:reset_i" "SEQ_CONTROLLER_0:reset_i" "SPEED_ID_IQ_PI_0:reset_i" "SVM_0:reset_i" "adc_interface_795x_0:reset_i" "apb3_hall_if_0:preset_i" "reset_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:sys_clk_i" "FOC_TRANSFORMS_0:sys_clk_i" "HALL_INTERFACE_C0_0:sys_clk_i" "OLMNG_0:sys_clk_i" "PWM3PH_0:sys_clk_i" "PWM_SCALING_0:sys_clk_i" "RATE_LIMITER_0:sys_clk_i" "SEQ_CONTROLLER_0:sys_clk_i" "SPEED_ID_IQ_PI_0:sys_clk_i" "SVM_0:sys_clk_i" "adc_interface_795x_0:sys_clk_i" "apb3_hall_if_0:pclk_i" "sys_clk_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:clear_buffer_i" "OLMNG_0:clear_buffer_i" "SEQ_CONTROLLER_0:motor_stopped_o" "SPEED_ID_IQ_PI_0:clear_buffer_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:fil_trig_i" "PWM3PH_0:midmatch_o" "SEQ_CONTROLLER_0:pwm_midmatch_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:ha_i" "HA_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:hall_sensor_pol_i" "apb3_hall_if_0:hall_sensor_polarity_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:hb_i" "HB_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:hc_i" "HC_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:cl_status_i" "SEQ_CONTROLLER_0:cl_status_o" "SPEED_ID_IQ_PI_0:speed_en_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:direction_config_i" "RATE_LIMITER_0:direction_i" "apb3_hall_if_0:direction_config_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:fault_clear_i" "apb3_hall_if_0:fault_clr_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:start_motor_i" "apb3_hall_if_0:start_motor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:stop_motor_i" "apb3_hall_if_0:stop_motor_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:adc_result_ch0_i" "adc_interface_795x_0:result_ch0_o" "apb3_hall_if_0:adc_ch0_val_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:adc_result_ch1_i" "adc_interface_795x_0:result_ch1_o" "apb3_hall_if_0:adc_ch1_val_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:adc_scale_val_i" "apb3_hall_if_0:adc_scale_val_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:fault_threshold_i" "apb3_hall_if_0:adc_oc_thresh_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:ia_adc_o" "FOC_TRANSFORMS_0:ia_i" "apb3_hall_if_0:ia_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:ib_adc_o" "FOC_TRANSFORMS_0:ib_i" "apb3_hall_if_0:ib_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:ialpha_i" "FOC_TRANSFORMS_0:ialpha_o" "apb3_hall_if_0:ialpha_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:ibeta_i" "FOC_TRANSFORMS_0:ibeta_o" "apb3_hall_if_0:ibeta_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:id_o" "SPEED_ID_IQ_PI_0:id_pi_act_input_i" "apb3_hall_if_0:id_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:iq_o" "SPEED_ID_IQ_PI_0:iq_pi_act_input_i" "apb3_hall_if_0:iq_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:theta_i" "OLMNG_0:theta_o" "apb3_hall_if_0:theta_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:va_o" "SVM_0:va_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:valpha_i" "FOC_TRANSFORMS_0:valpha_o" "apb3_hall_if_0:valpha_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:vb_o" "SVM_0:vb_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:vbeta_i" "FOC_TRANSFORMS_0:vbeta_o" "apb3_hall_if_0:vbeta_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:vc_o" "SVM_0:vc_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:vd_i" "SPEED_ID_IQ_PI_0:id_pi_output_o" "apb3_hall_if_0:id_pi_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:vq_i" "SEQ_CONTROLLER_0:vq_i" "SPEED_ID_IQ_PI_0:iq_pi_output_o" "apb3_hall_if_0:iq_pi_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:angle_out_raw_o" "apb3_hall_if_0:hall_angle_raw_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:filter_factor_i" "apb3_hall_if_0:hall_filter_factor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:omega_out_o" "SPEED_ID_IQ_PI_0:speed_pi_act_input_i" "apb3_hall_if_0:hall_omega_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:speed_factor_i" "apb3_hall_if_0:hall_speed_factor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HALL_INTERFACE_C0_0:theta_output_o" "OLMNG_0:theta_cl_i" "apb3_hall_if_0:hall_theta_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:dv_i" "apb3_hall_if_0:olmng_dv_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:iq_ref_in_i" "apb3_hall_if_0:olmng_iq_ref_in_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:speed_ref_i" "RATE_LIMITER_0:rl_out_o" "SEQ_CONTROLLER_0:speed_ref_i" "SPEED_ID_IQ_PI_0:speed_pi_ref_input_i" "apb3_hall_if_0:rl_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:theta_factor_i" "apb3_hall_if_0:olmng_theta_factor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PWM3PH_0:dead_time_i" "apb3_hall_if_0:pwm_dead_time_val_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PWM3PH_0:delay_time_i" "apb3_hall_if_0:pwm_delay_time_val_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PWM3PH_0:pwm_period_i" "PWM_SCALING_0:pwm_period_i" "apb3_hall_if_0:pwm_period_val_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"PWM_SCALING_0:pwm_gain_i" "apb3_hall_if_0:pwm_gain_val_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RATE_LIMITER_0:rate_count_i" "apb3_hall_if_0:rate_limit_rate_cnt_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RATE_LIMITER_0:rl_in_i" "apb3_hall_if_0:rate_limit_ref_in_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RATE_LIMITER_0:slew_count_i" "apb3_hall_if_0:rate_limit_slew_cnt_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:config_reg_i" "apb3_hall_if_0:seq_cntl_config_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:max_ar_i" "apb3_hall_if_0:auto_restart_no_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:speed_cl_i" "apb3_hall_if_0:seq_cntl_cl_omega_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:state_o" "apb3_hall_if_0:fsm_state_val_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SPEED_ID_IQ_PI_0:id_pi_ki_i" "SPEED_ID_IQ_PI_0:iq_pi_ki_i" "apb3_hall_if_0:idq_pi_ki_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SPEED_ID_IQ_PI_0:id_pi_kp_i" "SPEED_ID_IQ_PI_0:iq_pi_kp_i" "apb3_hall_if_0:idq_pi_kp_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SPEED_ID_IQ_PI_0:iq_pi_ref_input_i" "SPEED_ID_IQ_PI_0:speed_pi_output_o" "apb3_hall_if_0:speed_pi_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SPEED_ID_IQ_PI_0:speed_pi_ki_i" "apb3_hall_if_0:speed_pi_ki_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SPEED_ID_IQ_PI_0:speed_pi_kp_i" "apb3_hall_if_0:speed_pi_kp_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"adc_interface_795x_0:result_ch2_o" "apb3_hall_if_0:adc_ch2_val_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"adc_interface_795x_0:result_ch3_o" "apb3_hall_if_0:adc_ch3_val_i" }

# Add bus interface net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_APB_IF" "apb3_hall_if_0:APB3_IF" }

# Re-enable auto promotion of pins of type 'pad'
auto_promote_pad_pins -promote_all 1
# Save the SmartDesign 
save_smartdesign -sd_name ${sd_name}
# Generate SmartDesign "BLDC_HALL_Axis"
