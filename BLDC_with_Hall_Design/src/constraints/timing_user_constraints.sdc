...
#
#create_generated_clock  -name { MC_System_0/MC_System_sb_0/CCC_0/CCC_INST/INST_CCC_IP:GL0 } \
    #-divide_by 2  -multiply_by 4  \
    #-source { MC_System_0/MC_System_sb_0/CCC_0/CCC_INST/INST_CCC_IP:RCOSC_25_50MHZ  }  \
    #{ MC_System_0/MC_System_sb_0/CCC_0/CCC_INST/INST_CCC_IP:GL0  } 
#
#create_generated_clock  -name { MC_System_0/MC_System_sb_0/CCC_0/CCC_INST/INST_CCC_IP:GL1 } \
    #-divide_by 2  -multiply_by 4  \
    #-source { MC_System_0/MC_System_sb_0/CCC_0/CCC_INST/INST_CCC_IP:RCOSC_25_50MHZ  }  \
    #{ MC_System_0/MC_System_sb_0/CCC_0/CCC_INST/INST_CCC_IP:GL1  } 
...
set_input_delay -max 3.000 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL0 } { HA_i  } 
set_input_delay -min 1.300 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL0 } { HA_i  } 

set_input_delay -max 3.000 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL0 } { HB_i  } 
set_input_delay -min 1.300 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL0 } { HB_i  } 

set_input_delay -max 3.000 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL0 } { HC_i  } 
set_input_delay -min 1.300 -clock { MC_System_0/MC_System_sb_0/CCC_0/GL0 } { HC_i  } 
