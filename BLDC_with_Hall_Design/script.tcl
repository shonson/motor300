...
download_core -vlnv {Microchip:SolutionCore:HALL_INTERFACE:4.2.0} -location {www.microchip-ip.com/repositories/DirectCore}
...
file delete -force SK1ABLHL_2024_log.txt

save_log -file SK1ABLHL_2024_log.txt
