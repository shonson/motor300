 ...
 *
 * SVN $Revision: 6955 $
 * SVN $Date: 2014-10-10 13:27:15 +0530 (Fri, 10 Oct 2014) $
 */
...
/*=========================================================================*//**
  ...
  during the enumeration process. The Call-back function MSS_USBD_VENDOR_Init_cb()
  ...
  as a vendor class device. The call-back function MSS_USBD_VENDOR_get_descriptor_cb()
  ...
  Class Specific requests
  The MSS_USBD_VENDOR_process_request_cb() call-back function is implemented by
  ...
  MSS_USBD_VENDOR_process_request_cb() function. When the data stage is complete,
  the USBD_VENDOR_cep_data_in_cb() will be called to mark the completion of the
  ...
  MSS_USBD_VENDOR_process_request_cb() function. When the data stage is complete,
  the USBD_VENDOR_cep_data_out_cb() function will be called to mark the completion
  ...
  MSS_USBD_VENDOR_process_request_cb() function itself.
  ...
  driver implements the MSS_USBD_VENDOR_data_in_cb() and the MSS_USBD_VENDOR_data_out_cb()
  ...
  these call-back functions. The MSS_USBD_VENDOR_data_in_cb() call-back function
  ...
  MSS_USBD_VENDOR_data_out_cb() is called when the previously initiated OUT
