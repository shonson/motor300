...
download_core -vlnv {Microsemi:SolutionCore:RESOLVER_INTERFACE:4.2.0} -location {www.microchip-ip.com/repositories/DirectCore}
download_core -vlnv {Microsemi:SolutionCore:SEQ_CONTROLLER:4.1.1} -location {www.microchip-ip.com/repositories/DirectCore}
download_core -vlnv {Microsemi:SolutionCore:SINC3_FILTER:4.2.0} -location {www.microchip-ip.com/repositories/DirectCore}
...
file delete -force SK1ABLRS_2024_log.txt

save_log -file SK1ABLRS_2024_log.txt
