...
MSS_USB_HCIF_cep_is_rxstall_err
(
    void
)
{
...
static __INLINE void
MSS_USB_HCIF_cep_clr_retry_err
(
    void
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_cep_is_naktimeout_err
(
    void
)
{
 ...
 */
static __INLINE void
MSS_USB_HCIF_cep_flush_fifo
(
    mss_usb_ep_num_t ep_num
)
{
    /*shoud be set when TxPktRdy/RxPktRdy is set*/
 ...
 */
static __INLINE void
MSS_USB_HCIF_cep_set_naklimit
(
    uint8_t naklimit
)
{
    if((2u >= naklimit) && (naklimit <= 16u))
    {
...
static __INLINE void MSS_USB_HCIF_tx_ep_set_txpktrdy(mss_usb_ep_num_t ep_num)
{
    USB->ENDPOINT[ep_num].TX_CSR |= TxCSRL_HOST_EPN_TX_PKT_RDY_MASK;
}

static __INLINE uint8_t
MSS_USB_HCIF_tx_ep_is_txpktrdy
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_tx_ep_is_retry_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_clr_retry_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_flush_fifo_reg
(
    mss_usb_ep_num_t ep_num
)
{
    if(MSS_USB_HCIF_tx_ep_is_txpktrdy(ep_num))
    {
...
static __INLINE uint8_t
MSS_USB_HCIF_tx_ep_is_rxstall_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_clr_rxstall_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_clr_data_tog
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_tx_ep_is_naktimeout_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_clr_naktimeout_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_tx_ep_is_data_tog
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_write_data_tog
(
    mss_usb_ep_num_t ep_num,
    uint32_t data_tog
)
{
    ...
    USB->ENDPOINT[ep_num].TX_CSR = data_tog & 0x00000001;
}

static __INLINE void
MSS_USB_HCIF_tx_ep_set_data_tog_we
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_clr_data_tog_we
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_set_dma_mode1
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_set_dma_mode0
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_tx_ep_get_dma_mode
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_set_force_data_tog
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_clr_force_data_tog
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_disable_dma
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_tx_ep_is_dma_enabled
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_set_autoset
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_tx_ep_clr_autoset
(
    mss_usb_ep_num_t ep_num
)
{
 ...
 */
static __INLINE uint8_t
MSS_USB_HCIF_rx_ep_is_rxpktrdy
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_rx_ep_is_fifo_full
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_rx_ep_is_retry_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_clr_retry_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_rx_ep_is_naktimeout_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_clr_naktimeout_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_flush_fifo_reg
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_rx_ep_is_rxstall_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_clr_rxstall_err
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_clr_data_tog
(
    mss_usb_ep_num_t ep_num
)
{
 ...
 */
static __INLINE uint8_t
MSS_USB_HCIF_rx_ep_is_iso_incomp
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_rx_ep_is_data_tog
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_write_data_tog
(
    mss_usb_ep_num_t ep_num,
    uint32_t data_tog
)
...
static __INLINE void
MSS_USB_HCIF_rx_ep_set_data_tog_we
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_clr_data_tog_we
(
    mss_usb_ep_num_t ep_num
)
{
...
MSS_USB_HCIF_rx_ep_get_dma_mode
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_set_dma_mode1
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_set_dma_mode0
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_disable_dma
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE uint8_t
MSS_USB_HCIF_rx_ep_is_dma_enabled
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_set_autoreq
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_clr_autoreq
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_set_autoclr
(
    mss_usb_ep_num_t ep_num
)
{
...
static __INLINE void
MSS_USB_HCIF_rx_ep_clr_autoclr
(
    mss_usb_ep_num_t ep_num
)
{
 ...
 */
static __INLINE void
MSS_USB_HCIF_tx_ep_set_target_speed
(
    mss_usb_ep_num_t ep_num,
...
)
{
    ...
    USB->ENDPOINT[ep_num].TX_TYPE |= (speed << TXTYPE_HOST_TARGET_EP_SPEED_SHIFT);
}

static __INLINE mss_usb_device_speed_t
MSS_USB_HCIF_tx_ep_get_target_speed
(
    mss_usb_ep_num_t ep_num
)
{
    return ((mss_usb_device_speed_t)((USB->ENDPOINT[ep_num].TX_TYPE & TXTYPE_HOST_TARGET_EP_SPEED_MASK)
                                                                    >> TXTYPE_HOST_TARGET_EP_SPEED_SHIFT));
}

static __INLINE void
MSS_USB_HCIF_tx_ep_set_target_protocol
(
    mss_usb_ep_num_t ep_num,
...
)
{
    ...
    USB->ENDPOINT[ep_num].TX_TYPE |= (xfr_type << TXTYPE_HOST_TARGET_EP_PROTOCOL_SHIFT);
}

static __INLINE mss_usb_xfr_type_t
MSS_USB_HCIF_tx_ep_get_target_protocol
(
    mss_usb_ep_num_t ep_num
)
{
    return ((mss_usb_xfr_type_t)((USB->ENDPOINT[ep_num].TX_TYPE & TXTYPE_HOST_TARGET_EP_PROTOCOL_MASK)
                                                                >> TXTYPE_HOST_TARGET_EP_PROTOCOL_SHIFT));
}

static __INLINE void
MSS_USB_HCIF_tx_ep_set_target_ep_no
(
    mss_usb_ep_num_t ep_num,
    uint8_t tdev_ep_num
)
{
    ...
    USB->ENDPOINT[ep_num].TX_TYPE |= (tdev_ep_num << TXTYPE_HOST_TARGET_EP_NUM_SHIFT);
}

static __INLINE uint8_t
MSS_USB_HCIF_tx_ep_get_target_ep_no
(
    mss_usb_ep_num_t ep_num
)
{
    return ((mss_usb_ep_num_t)((USB->ENDPOINT[ep_num].TX_TYPE & TXTYPE_HOST_TARGET_EP_NUM_MASK)
                                                                >> TXTYPE_HOST_TARGET_EP_NUM_SHIFT));
}

static __INLINE void
MSS_USB_HCIF_tx_ep_clr_txtypereg
(
    mss_usb_ep_num_t ep_num
)
{
    USB->ENDPOINT[ep_num].TX_TYPE = 0x0000;
}
/*******************************************************************************
 * TXINTERVAL register related APIs
 */
static __INLINE void
MSS_USB_HCIF_tx_ep_set_target_interval
(
    mss_usb_ep_num_t ep_num,
    uint8_t interval
)
{
    /*
      meaning of the value depends on Speed and transfer type.
      HCIF driver should take care of this.
    */
    if((2u >= interval) && (interval <= 16u))
    {
 ...
 */
static __INLINE void
MSS_USB_HCIF_rx_ep_set_target_speed
(
    mss_usb_ep_num_t ep_num,
    mss_usb_device_speed_t speed
)
...
static __INLINE mss_usb_device_speed_t
MSS_USB_HCIF_rx_ep_get_target_speed
(
    mss_usb_ep_num_t ep_num
)
{
    return ((mss_usb_device_speed_t)((USB->ENDPOINT[ep_num].RX_TYPE & RXTYPE_HOST_TARGET_EP_SPEED_MASK)
                                                                    >> RXTYPE_HOST_TARGET_EP_SPEED_SHIFT));
}

static __INLINE void
MSS_USB_HCIF_rx_ep_set_target_protocol
(
    mss_usb_ep_num_t ep_num,
    mss_usb_xfr_type_t xfr_type
)
...
static __INLINE mss_usb_xfr_type_t
MSS_USB_HCIF_rx_ep_get_target_protocol
(
    mss_usb_ep_num_t ep_num
)
{
    return ((mss_usb_xfr_type_t)((USB->ENDPOINT[ep_num].RX_TYPE & RXTYPE_HOST_TARGET_EP_PROTOCOL_MASK)
                                                                >> RXTYPE_HOST_TARGET_EP_PROTOCOL_SHIFT));
}

static __INLINE void
MSS_USB_HCIF_rx_ep_set_target_ep_no
(
    mss_usb_ep_num_t ep_num,
    uint8_t tdev_ep_num
)
...
static __INLINE uint8_t
MSS_USB_HCIF_rx_ep_get_target_ep_no
(
    mss_usb_ep_num_t ep_num
)
{
    return ((mss_usb_ep_num_t)((USB->ENDPOINT[ep_num].RX_TYPE & RXTYPE_HOST_TARGET_EP_NUM_MASK)
                                                            >> RXTYPE_HOST_TARGET_EP_NUM_SHIFT));
}

static __INLINE void
MSS_USB_HCIF_rx_ep_clr_rxtypereg
(
    mss_usb_ep_num_t ep_num
)
{
    USB->ENDPOINT[ep_num].RX_TYPE = 0x0000;
}
/*******************************************************************************
 * RXINTERVAL register related APIs
 */
static __INLINE void
MSS_USB_HCIF_rx_ep_set_target_interval
(
    mss_usb_ep_num_t ep_num,
    uint8_t interval
)
{
    /*
     meaning of the value depend on Speed and transfer type.
     HCIF driver should take care of this.
    */
    if((2u >= interval) && (interval <= 16u))
    {
 ...
 */
static __INLINE void
MSS_USB_HCIF_rx_ep_set_req_pkt_count
(
    mss_usb_ep_num_t ep_num,
    uint32_t count
)
 ...
 */
static __INLINE void
MSS_USB_HCIF_rx_ep_set_target_func_addr
(
    mss_usb_ep_num_t ep_num,
    uint32_t addr
)
{
    /*Device number of the target - initially zero, then determined by enumeration process.*/
 ...
 */
static __INLINE void
MSS_USB_HCIF_tx_ep_set_target_hub_addr
(
    mss_usb_ep_num_t ep_num,
    uint32_t addr,
    uint32_t mtt
...
{
    /*Device number of the target - initially zero, then determined by enumeration process.*/
    USB->TAR[ep_num].TX_HUB_ADDR = ((uint8_t)(mtt << TARGET_DEVICE_HUB_MT_SHIFT) | (addr & 0x7Fu));
}
 ...
 */
static __INLINE void
MSS_USB_HCIF_rx_ep_set_target_hub_addr
(
    mss_usb_ep_num_t ep_num,
    uint32_t addr,
    uint32_t mtt
...
{
    /*Device number of the target - initially zero, then determined by enumeration process.*/
    USB->TAR[ep_num].RX_HUB_ADDR = ((uint8_t)(mtt << TARGET_DEVICE_HUB_MT_SHIFT) | (addr & 0x7Fu));
}
 ...
 */
static __INLINE void
MSS_USB_HCIF_tx_ep_set_target_hub_port
(
    mss_usb_ep_num_t ep_num,
    uint32_t port_no
)
 ...
 */
static __INLINE void
MSS_USB_HCIF_rx_ep_set_target_hub_port
(
    mss_usb_ep_num_t ep_num,
    uint32_t port_no
)
