...
sd_create_scalar_port -sd_name ${sd_name} -port_name {PPS} -port_direction {IN}
sd_create_scalar_port -sd_name ${sd_name} -port_name {TD} -port_direction {IN}
...
sd_create_scalar_port -sd_name ${sd_name} -port_name {GPIO_41} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {GPIO_43} -port_direction {OUT}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Bldc_Axis_0:clk_adc_i" "GPIO_43" "MC_System_0:Clock_25M" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Bldc_Axis_0:data_adc_COS" "TD" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Bldc_Axis_0:data_adc_SIN" "PPS" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Bldc_Axis_0:hf_signal_o" "GPIO_41" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Bldc_Axis_0:reset_i" "MC_System_0:FIC_0_LOCK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Bldc_Axis_0:BLDC_APB_IF" "MC_System_0:AMBA_SLAVE_0" }
