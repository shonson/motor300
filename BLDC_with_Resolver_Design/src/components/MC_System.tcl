...
sd_create_scalar_port -sd_name ${sd_name} -port_name {Clock_25M} -port_direction {OUT}
...
sd_create_pin_group -sd_name ${sd_name} -group_name {FAB_CCC_PINS} -instance_name {MC_System_sb_0} -pin_names {"FAB_CCC_GL1" "FAB_CCC_LOCK" "FAB_CCC_GL2" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Clock_25M" "MC_System_sb_0:FAB_CCC_GL2" }
