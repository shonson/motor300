# Creating SmartDesign "Bldc_Axis"
set sd_name {Bldc_Axis}
...
sd_create_scalar_port -sd_name ${sd_name} -port_name {clk_adc_i} -port_direction {IN}
sd_create_scalar_port -sd_name ${sd_name} -port_name {data_adc_COS} -port_direction {IN}
sd_create_scalar_port -sd_name ${sd_name} -port_name {data_adc_SIN} -port_direction {IN}
...
sd_create_scalar_port -sd_name ${sd_name} -port_name {hf_signal_o} -port_direction {OUT}
...
sd_instantiate_hdl_core -sd_name ${sd_name} -hdl_core_name {adc_interface_795x} -instance_name {adc_interface_795x_0}
# Exporting Parameters of instance adc_interface_795x_0
sd_configure_core_instance -sd_name ${sd_name} -instance_name {adc_interface_795x_0} -params {\
"g_ADC_RES:12" \
"g_SCK_DIVIDER:3" }\
-validate_rules 0
sd_save_core_instance_config -sd_name ${sd_name} -instance_name {adc_interface_795x_0}
sd_update_instance -sd_name ${sd_name} -instance_name {adc_interface_795x_0}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {apb3_if_0:ealpha_i} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {apb3_if_0:ebeta_i} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {apb3_if_0:ealpha_filter_out_i} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {apb3_if_0:ebeta_filter_out_i} -value {GND}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:Ls_by_Ts_pu_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:Rs_pu_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:angle_kp_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:angle_ki_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:filter_factor_bemf_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {apb3_if_0:filter_factor_omega_o}
...
# Add RESOLVER_INTERFACE_0 instance
sd_instantiate_core -sd_name ${sd_name} -core_vlnv Microsemi:SolutionCore:RESOLVER_INTERFACE:$RESOLVER_INTERFACEver -instance_name {RESOLVER_INTERFACE_0}
# Exporting Parameters of instance RESOLVER_INTERFACE_0
sd_configure_core_instance -sd_name ${sd_name} -instance_name {RESOLVER_INTERFACE_0} -params {\
"FAMILY:19" \
"g_NO_MCYCLE_PATH:2" \
"HDL_License:O" \
"testbench:User" }\
-validate_rules 0
sd_save_core_instance_config -sd_name ${sd_name} -instance_name {RESOLVER_INTERFACE_0}
...
# Add SINC3_FILTER_0 instance
sd_instantiate_core -sd_name ${sd_name} -core_vlnv Microsemi:SolutionCore:SINC3_FILTER:$SINC3_FILTERver -instance_name {SINC3_FILTER_0}
# Exporting Parameters of instance SINC3_FILTER_0
sd_configure_core_instance -sd_name ${sd_name} -instance_name {SINC3_FILTER_0} -params {\
"FAMILY:19" \
"g_BIPOLAR:0" \
"g_DECIMATION_FACTOR:6" \
"g_NEGATE_OUTPUT:0" \
"g_STD_IO_WIDTH:18" \
"HDL_License:O" \
"testbench:User" }\
-validate_rules 0
sd_save_core_instance_config -sd_name ${sd_name} -instance_name {SINC3_FILTER_0}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {SINC3_FILTER_0:clk_dec_o}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {SINC3_FILTER_0:hold_i} -value {GND}



# Add SINC3_FILTER_2 instance
sd_instantiate_core -sd_name ${sd_name} -core_vlnv Microsemi:SolutionCore:SINC3_FILTER:$SINC3_FILTERver -instance_name {SINC3_FILTER_2}
# Exporting Parameters of instance SINC3_FILTER_2
sd_configure_core_instance -sd_name ${sd_name} -instance_name {SINC3_FILTER_2} -params {\
"FAMILY:19" \
"g_BIPOLAR:0" \
"g_DECIMATION_FACTOR:6" \
"g_NEGATE_OUTPUT:0" \
...
"testbench:User" }\
-validate_rules 0
sd_save_core_instance_config -sd_name ${sd_name} -instance_name {SINC3_FILTER_2}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {SINC3_FILTER_2:clk_dec_o}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {SINC3_FILTER_2:hold_i} -value {GND}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {SPEED_ID_IQ_PI_0:speed_pi_ymax_i} -value {011111111111111111}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {SPEED_ID_IQ_PI_0:speed_pi_ymin_i} -value {100000000000000001}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:reset_i" "FOC_TRANSFORMS_0:reset_i" "OLMNG_0:reset_i" "PWM3PH_0:reset_i" "PWM_SCALING_0:reset_i" "RATE_LIMITER_0:reset_i" "RESOLVER_INTERFACE_0:reset_i" "SEQ_CONTROLLER_0:reset_i" "SINC3_FILTER_0:reset_i" "SINC3_FILTER_2:reset_i" "SPEED_ID_IQ_PI_0:reset_i" "SVM_0:reset_i" "adc_interface_795x_0:reset_i" "apb3_if_0:preset_i" "reset_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:sys_clk_i" "FOC_TRANSFORMS_0:sys_clk_i" "OLMNG_0:sys_clk_i" "PWM3PH_0:sys_clk_i" "PWM_SCALING_0:sys_clk_i" "RATE_LIMITER_0:sys_clk_i" "RESOLVER_INTERFACE_0:sys_clk_i" "SEQ_CONTROLLER_0:sys_clk_i" "SPEED_ID_IQ_PI_0:sys_clk_i" "SVM_0:sys_clk_i" "adc_interface_795x_0:sys_clk_i" "apb3_if_0:pclk_i" "sys_clk_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:clear_buffer_i" "RESOLVER_INTERFACE_0:clear_buffer_i" "SEQ_CONTROLLER_0:motor_stopped_o" "SPEED_ID_IQ_PI_0:clear_buffer_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:direction_config_i" "RATE_LIMITER_0:direction_i" "apb3_if_0:direction_config_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:start_i" "RATE_LIMITER_0:rl_done_o" "SPEED_ID_IQ_PI_0:speed_pi_start_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:calib_angle_i" "SEQ_CONTROLLER_0:sensor_reset_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:hf_signal_o" "hf_signal_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:fault_clear_i" "apb3_if_0:fault_clr_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:start_motor_i" "apb3_if_0:start_motor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:stop_motor_i" "apb3_if_0:stop_motor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SINC3_FILTER_0:clk_adc_i" "SINC3_FILTER_2:clk_adc_i" "clk_adc_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SINC3_FILTER_0:data_adc_i" "data_adc_SIN" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SINC3_FILTER_2:data_adc_i" "data_adc_COS" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:adc_result_ch0_i" "adc_interface_795x_0:result_ch0_o" "apb3_if_0:adc_ch0_val_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:adc_result_ch1_i" "adc_interface_795x_0:result_ch1_o" "apb3_if_0:adc_ch1_val_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:adc_scale_val_i" "apb3_if_0:adc_scale_val_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:fault_threshold_i" "apb3_if_0:adc_oc_thresh_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:ia_adc_o" "FOC_TRANSFORMS_0:ia_i" "apb3_if_0:ia_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ADC_SCALING_0:ib_adc_o" "FOC_TRANSFORMS_0:ib_i" "apb3_if_0:ib_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:ialpha_i" "FOC_TRANSFORMS_0:ialpha_o" "apb3_if_0:ialpha_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:ibeta_i" "FOC_TRANSFORMS_0:ibeta_o" "apb3_if_0:ibeta_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:id_o" "SPEED_ID_IQ_PI_0:id_pi_act_input_i" "apb3_if_0:id_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:iq_o" "SPEED_ID_IQ_PI_0:iq_pi_act_input_i" "apb3_if_0:iq_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:theta_i" "OLMNG_0:theta_o" "apb3_if_0:theta_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:va_o" "SVM_0:va_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:valpha_i" "FOC_TRANSFORMS_0:valpha_o" "apb3_if_0:valpha_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:vb_o" "SVM_0:vb_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:vbeta_i" "FOC_TRANSFORMS_0:vbeta_o" "apb3_if_0:vbeta_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:vc_o" "SVM_0:vc_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:vd_i" "SPEED_ID_IQ_PI_0:id_pi_output_o" "apb3_if_0:id_pi_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FOC_TRANSFORMS_0:vq_i" "SEQ_CONTROLLER_0:vq_i" "SPEED_ID_IQ_PI_0:iq_pi_output_o" "apb3_if_0:iq_pi_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:dv_i" "apb3_if_0:olmng_dv_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:iq_ref_in_i" "apb3_if_0:olmng_iq_ref_in_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:speed_ref_i" "RATE_LIMITER_0:rl_out_o" "SEQ_CONTROLLER_0:speed_ref_i" "SPEED_ID_IQ_PI_0:speed_pi_ref_input_i" "apb3_if_0:rl_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:theta_cl_i" "RESOLVER_INTERFACE_0:theta_o" "apb3_if_0:pll_theta_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"OLMNG_0:theta_factor_i" "apb3_if_0:olmng_theta_factor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PWM3PH_0:dead_time_i" "apb3_if_0:pwm_dead_time_val_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PWM3PH_0:delay_time_i" "apb3_if_0:pwm_delay_time_val_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PWM3PH_0:pwm_period_i" "PWM_SCALING_0:pwm_period_i" "apb3_if_0:pwm_period_val_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"PWM_SCALING_0:pwm_gain_i" "apb3_if_0:pwm_gain_val_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RATE_LIMITER_0:rate_count_i" "apb3_if_0:rate_limit_rate_cnt_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RATE_LIMITER_0:rl_in_i" "apb3_if_0:rate_limit_ref_in_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RATE_LIMITER_0:slew_count_i" "apb3_if_0:rate_limit_slew_cnt_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:ac_filter_factor_i" "apb3_if_0:ac_filter_factor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:cos_i" "SINC3_FILTER_2:data_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:dc_filter_factor_i" "apb3_if_0:dc_filter_factor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:hf_sig_period_i" "apb3_if_0:hf_sig_period_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:pll_pi_ki_i" "apb3_if_0:pll_pi_ki_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:pll_pi_kp_i" "apb3_if_0:pll_pi_kp_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:pp_ratio_i" "apb3_if_0:pp_ratio_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:sin_i" "SINC3_FILTER_0:data_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:speed_o" "SPEED_ID_IQ_PI_0:speed_pi_act_input_i" "apb3_if_0:omega_filter_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESOLVER_INTERFACE_0:theta_factor_i" "apb3_if_0:theta_factor_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:config_reg_i" "apb3_if_0:seq_cntl_config_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:max_ar_i" "apb3_if_0:auto_restart_no_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:speed_cl_i" "apb3_if_0:seq_cntl_cl_omega_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SEQ_CONTROLLER_0:state_o" "apb3_if_0:fsm_state_val_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SPEED_ID_IQ_PI_0:id_pi_ki_i" "SPEED_ID_IQ_PI_0:iq_pi_ki_i" "apb3_if_0:idq_pi_ki_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SPEED_ID_IQ_PI_0:id_pi_kp_i" "SPEED_ID_IQ_PI_0:iq_pi_kp_i" "apb3_if_0:idq_pi_kp_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SPEED_ID_IQ_PI_0:iq_pi_ref_input_i" "SPEED_ID_IQ_PI_0:speed_pi_output_o" "apb3_if_0:speed_pi_out_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SPEED_ID_IQ_PI_0:speed_pi_ki_i" "apb3_if_0:speed_pi_ki_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"SPEED_ID_IQ_PI_0:speed_pi_kp_i" "apb3_if_0:speed_pi_kp_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"adc_interface_795x_0:result_ch2_o" "apb3_if_0:adc_ch2_val_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"adc_interface_795x_0:result_ch3_o" "apb3_if_0:adc_ch3_val_i" }

# Add bus interface net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"BLDC_APB_IF" "apb3_if_0:BLDC_APB_IF" }

# Re-enable auto promotion of pins of type 'pad'
auto_promote_pad_pins -promote_all 1
# Save the SmartDesign 
save_smartdesign -sd_name ${sd_name}
# Generate SmartDesign "Bldc_Axis"
