...
configure_tool -name {SYNTHESIZE} \
    ...
    -params {PA4_GB_MAX_RCLKINT_INSERTION:8} \
...
configure_tool -name {VERIFYTIMING} \
    ...
    -params {MAX_TIMING_SLOW_LV_LT:true} \
    -params {MIN_TIMING_FAST_HV_LT:1} \
    -params {MIN_TIMING_SLOW_LV_HT:1} \
    -params {MIN_TIMING_SLOW_LV_LT:true} \
    ...
    -params {MAX_TIMING_VIOLATIONS_SLOW_LV_LT:true} \
    -params {MIN_TIMING_VIOLATIONS_FAST_HV_LT:1} \
    -params {MIN_TIMING_VIOLATIONS_SLOW_LV_HT:1} \
    -params {MIN_TIMING_VIOLATIONS_SLOW_LV_LT:true} 
...
run_tool_wrapper "run_tool -name VERIFYPOWER
"

puts "Verify Power completed successfully\n"
